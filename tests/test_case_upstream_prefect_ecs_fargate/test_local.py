...
Usage (from project root):
    python -m tests.test_case_upstream_prefect_ecs_fargate.test_local
    python -m tests.test_case_upstream_prefect_ecs_fargate.test_local --fail
    python -m tests.test_case_upstream_prefect_ecs_fargate.test_local --cloud
"""
