...
Workflow Orchestration1. Plan Mode DefaultEnter plan mode for ANY non-trivial task (3+ steps or architectural decisions)
...
Task ManagementPlan First: Write plan to 'tasks/todo.md' with checkable items
...
Core PrinciplesSimplicity First: Make every change as simple as possible. Impact minimal code.
